...
Next.js 13 introduces a new way to use fonts.
...
The font system allows us to import fonts directly from google fonts e.g.:
...
After we have imported the fonts we can create an instance and use it in our jsx e.g.:
...
But this is not what we like to use in a tailwind project.
...
And now we are able to use our fonts with tailwind generated classes e.g.:
...
* [Next.js font documentation](https://beta.nextjs.org/docs/optimizing/fonts)
