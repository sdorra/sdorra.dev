---
title: Fathom with Next.js 13
date: 2022-11-11
summary: This article explains how to use fathom with Next.js 13
---
In this article we will explore how to use [fathom analytics](https://usefathom.com/) with the Next.js 13 app directory.
...
So we have to track route changes by our self.
...
sends an `routeChange` event afterwards.

## Next.js

In Next.js we could use our method with the `Script` tag e.g.:
...
We have to use a custom component instead of hook in order to annotate the component with [use client](https://beta.nextjs.org/docs/rendering/server-and-client-components#client-components).
