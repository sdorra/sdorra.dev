...
This could break designs which are using a height of 100% percent.

As [timneutkens](https://github.com/timneutkens) says (one of the Next.js maintainers), the problem is temporary but it has to be fixed in react:
...
> Unlike in pages the new router has improved scroll and focus handling. It ensures only the changed part is scrolled into view and put focus on.
>
...
[Original post](https://github.com/vercel/next.js/discussions/41745#discussioncomment-3964086).
...
For example, we can specify `display: contents` as suggested by [bmcmahen](https://github.com/bmcmahen) on the discussion at [vercel](https://github.com/vercel/next.js/discussions/41745#discussioncomment-3998683) e.g:
...
But they mention also accessibility issues:
