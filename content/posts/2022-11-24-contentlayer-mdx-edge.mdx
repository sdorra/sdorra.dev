...
`1mb` is not very much, but it should be enough for those two imports.
...
For this reason I opened ticket [contentlayerdev/contentlayer#339](https://github.com/contentlayerdev/contentlayer/issues/339).
